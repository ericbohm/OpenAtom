...
{//begin routine
  ...
  CProxy_NodeMap2DArray rhorsCrayMap = CProxy_NodeMap2DArray::ckNew(config.rhoRsubplanes,nchareRhoR*config.rhoRsubplanes,0,4,0);
  ...
  CProxy_NodeMap2DArray rhogsCrayMap = CProxy_NodeMap2DArray::ckNew(1,nchareRhoG*1,0,4,0);
  ...
  if(ees_eext_on) {
    ...
    CProxy_NodeMap2DArray rhorHartCrayMap = CProxy_NodeMap2DArray::ckNew(config.rhoRsubplanes*nchareHartAtmT,nchareRhoRHart*config.rhoRsubplanes*nchareHartAtmT,0,4,0);
  ...
  CProxy_NodeMap2DArray rhogHartCrayMap = CProxy_NodeMap2DArray::ckNew(nchareHartAtmT,nchareRhoGHart*nchareHartAtmT,0,4,0);
