...
// Useful Local variables
 ...
 fftStreamer = CProxy_ArrayMeshStreamer<streamedChunk, CProxy_MeshStreamerArray2DClient<streamedChunk>, CkArrayIndex2D>::ckNew(1024, 3, meshStreamerDims, UrealSpacePlaneProxy[thisInstance.proxyOffset], 0, 10);
