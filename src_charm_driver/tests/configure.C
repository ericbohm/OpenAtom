...
//===================================================================================
void Config::readConfig(char* input_name,int nstates_in, int nplanes_in, int maxIter_in,int numPes_in)
//===================================================================================
   {//begin routine
//===================================================================================
...
//  int nplane_x     = minx+1;
  int nplane_x = nplanes_in;
//  int nplane_x_rho = 2*minx+1;
  PRINTF("  nplane = %d for the current system\n",
         nplane_x);
...
// Improve user parameters and/or try to optimize unset parameters
  ...
  guesstimateParmsConfig(dict_gen,dict_rho,dict_state,dict_pc,dict_nl,dict_map);

//===================================================================================
// Final consistency checks

  Finale(nplane_x,cp_min_opt);
 ...
 */
//=============================================================================
void Config::guesstimateParmsConfig(DICT_WORD *dict_gen,DICT_WORD *dict_rho,
...
//ccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
//===================================================================================
  void Config::Finale(int nplane_x, int cp_min_opt){
//===================================================================================
