...
#---------------------------------------------------------------
#--------- Flags for linking ---------#
               LDFLAGS  += -L$(FFT_HOME)/lib -L$(TACC_ACML_LIB) -memory os -thread context
               LDLIBS   += -module CkMulticast -module comlib -lz -lconv-util -lacml -lm -pgf90libs
