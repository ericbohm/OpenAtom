...
Make sure that the coordinates must follow the order that you set in \verb+water.set+, i.e., the first two coordinates for H, and the third coordinate for O. 
