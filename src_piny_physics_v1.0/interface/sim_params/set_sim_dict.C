...
{ /*begin routine*/
  ...
  *num_dict = 14;
  *dict = (DICT_WORD *)cmalloc(*num_dict*sizeof(DICT_WORD),"set_sim_dict_list")-1;
...
{ /*begin routine*/
  ...
  *dict = (DICT_WORD *)cmalloc(*num_dict*sizeof(DICT_WORD),"set_sim_dict_cp")-1;
  ...
  /*-----------------------------------------------------------------------*/ 
  /* 7)\cp_dft_typ{lda,lsda,gga_lda,gga_lsda} */
  strcpy((*dict)[7].error_mes,"lda,lsda,gga_lda,gga_lsda");
  strcpy((*dict)[7].keyword,"cp_dft_typ");
  strcpy((*dict)[7].keyarg,"lda");
  /*-----------------------------------------------------------------------*/ 
  /* 8)\cp_nl_list{on,off} */
  strcpy((*dict)[8].error_mes,"on,off");
  strcpy((*dict)[8].keyword,"cp_nl_list");
  strcpy((*dict)[8].keyarg,"off");
  /*-----------------------------------------------------------------------*/
  /* 9)\cp_mass_tau_def{#} */
  strcpy((*dict)[9].error_mes,"a number > 0 ");
  strcpy((*dict)[9].keyword,"cp_mass_tau_def");
  strcpy((*dict)[9].keyarg,"25");
  /*-----------------------------------------------------------------------*/ 
  /* 10)\cp_mass_cut_def{#} */
  strcpy((*dict)[10].error_mes,"a number > 0 ");
  strcpy((*dict)[10].keyword,"cp_mass_cut_def");
  strcpy((*dict)[10].keyarg,"2");
  /*-----------------------------------------------------------------------*/ 
  /* 11)\cp_energy_cut_def{#} */
  strcpy((*dict)[11].error_mes,"a number > 0 ");
  strcpy((*dict)[11].keyword,"cp_energy_cut_def");
  ...
  strcpy((*dict)[13].keyword,"cp_ptens");
  strcpy((*dict)[13].keyarg,"off");
  /*-----------------------------------------------------------------------*/ 
  /* 14)\cp_init_orthog{on,off} */
  strcpy((*dict)[14].error_mes,"on,off");
  strcpy((*dict)[14].keyword,"cp_init_orthog");
  strcpy((*dict)[14].keyarg,"off");
  /*-----------------------------------------------------------------------*/ 
  /* 15)\cp_cg_line_min_len{#} */
  strcpy((*dict)[15].error_mes,"a number >= 3");
  strcpy((*dict)[15].keyword,"cp_cg_line_min_len");
  strcpy((*dict)[15].keyarg,"0");
  /*-----------------------------------------------------------------------*/ 
  /* 16)\cp_minimize_typ{min_std,min_cg,min_diis} */
  strcpy((*dict)[16].error_mes,"min_std,min_cg,min_diis");
  strcpy((*dict)[16].keyword,"cp_minimize_typ");
  strcpy((*dict)[16].keyarg,"min_std");
  /*-----------------------------------------------------------------------*/ 
  /* 17)\cp_diis_hist_len{#} */
  strcpy((*dict)[17].error_mes,"a number >= 0");
  strcpy((*dict)[17].keyword,"cp_diis_hist_len");
  strcpy((*dict)[17].keyarg,"10");
  /*-----------------------------------------------------------------------*/ 
  /* 18)\cp_orth_meth{gram_schmidt,lowdin,normalize,none} */
  strcpy((*dict)[18].error_mes,"gram_schmidt,lowdin,normalize,none");
  strcpy((*dict)[18].keyword,"cp_orth_meth");
  strcpy((*dict)[18].keyarg,"gram_schmidt");
  /*-----------------------------------------------------------------------*/ 
  /* 19)\cp_restart_type{gen_wave,initial,restart_pos,restart_posvel,restart_all}*/
  strcpy((*dict)[19].error_mes,"initial");
  strcpy((*dict)[19].keyword,"cp_restart_type");
  strcpy((*dict)[19].keyarg,"gen_wave");
  /*-----------------------------------------------------------------------*/ 
  /*  20)\diis_hist_len{#} */
  strcpy((*dict)[20].error_mes,"a number >= 0");
  strcpy((*dict)[20].keyword,"diis_hist_len");
  strcpy((*dict)[20].keyarg,"10");
  /*-----------------------------------------------------------------------*/ 
  /* 21)\nlvps_list_skin{#}   */
  strcpy((*dict)[21].error_mes,"a number > 0");
  strcpy((*dict)[21].keyword,"nlvps_list_skin");
  strcpy((*dict)[21].keyarg,"50.0");
  /*-----------------------------------------------------------------------*/ 
  /* 22)\gradient_cutoff{#}   */
  strcpy((*dict)[22].error_mes,"a number > 0");
  strcpy((*dict)[22].keyword,"gradient_cutoff");
  strcpy((*dict)[22].keyarg,"5.0e-05");
  /*-----------------------------------------------------------------------*/
  /* 23)\zero_cp_vel{initial,periodic,no}   */
  strcpy((*dict)[23].error_mes,"initial periodic,,no");
  strcpy((*dict)[23].keyword,"zero_cp_vel");
  strcpy((*dict)[23].keyarg,"no");

  /*-----------------------------------------------------------------------*/
  /* 24)\cp_check_clus{#}   */
  strcpy((*dict)[24].error_mes,"on,off");
  strcpy((*dict)[24].keyword,"cp_check_perd_size");
  strcpy((*dict)[24].keyarg,"on");

  /*-----------------------------------------------------------------------*/
  /* 25)\cp_tol_edge_dist{#}   */
  strcpy((*dict)[25].error_mes,"a number > 0");
  strcpy((*dict)[25].keyword,"cp_tol_edge_dist");
  strcpy((*dict)[25].keyarg,"3");
  /*-----------------------------------------------------------------------*/
  /* 26)\cp_dual_grid_opt{#} */
  strcpy((*dict)[26].error_mes,"prop,not_prop or off");
  strcpy((*dict)[26].keyword,"cp_dual_grid_opt");
  strcpy((*dict)[26].keyarg,"off");

  /*-----------------------------------------------------------------------*/
  /* 27)\cp_check_dual_size{#}   */
  strcpy((*dict)[27].error_mes,"on,off");
  strcpy((*dict)[27].keyword,"cp_check_dual_size");
  strcpy((*dict)[27].keyarg,"on");
  /*-----------------------------------------------------------------------*/
  /* 28)\cp_move_dual_box_opt{#}   */
  strcpy((*dict)[28].error_mes,"on,off");
  strcpy((*dict)[28].keyword,"cp_move_dual_box_opt");
  strcpy((*dict)[28].keyarg,"off");

  /*-----------------------------------------------------------------------*/ 
  /* 29)\cp_energy_cut_dual_grid_def{#} */
  strcpy((*dict)[29].error_mes,"a number > 0 ");
  strcpy((*dict)[29].keyword,"cp_energy_cut_dual_grid_def");
  strcpy((*dict)[29].keyarg,"2");
  /*-----------------------------------------------------------------------*/ 
  /* 30)\cp_alpha_conv_dual{#} */
  strcpy((*dict)[30].error_mes,"a number > 0 ");
  strcpy((*dict)[30].keyword,"cp_alpha_conv_dual");
  strcpy((*dict)[30].keyarg,"7");

  /*-----------------------------------------------------------------------*/ 
  /* 31)\interp_pme_dual{#} */
  strcpy((*dict)[31].error_mes,"an even number >= 4 ");
  strcpy((*dict)[31].keyword,"interp_pme_dual");
  strcpy((*dict)[31].keyarg,"4");
  /*-----------------------------------------------------------------------*/ 
  /* 32)\cp_elf_calc_frq{#} */
  strcpy((*dict)[32].error_mes,"a number >= 0");
  strcpy((*dict)[32].keyword,"cp_elf_calc_frq");
  strcpy((*dict)[32].keyarg,"0");
  /*-----------------------------------------------------------------------*/ 
  /* 33)\cp_ngrid_skip{#} */
  strcpy((*dict)[33].error_mes,"a number > 0");
  strcpy((*dict)[33].keyword,"cp_ngrid_skip");
  strcpy((*dict)[33].keyarg,"1");
  /*-----------------------------------------------------------------------*/ 
  /* 34)\cp_isok_opt{#} */
  strcpy((*dict)[34].error_mes,"on,off");
...
{ /*begin routine*/
  ...
  *dict = (DICT_WORD *)cmalloc(*num_dict*sizeof(DICT_WORD),"set_sim_dict_vpot")-1;
  ...
  /*-----------------------------------------------------------------------*/ 
  /*  25)\inter_calc_opt{#} */
  strcpy((*dict)[25].error_mes,"spline or grind");
...
{ /*begin routine*/
  ...
  *dict = (DICT_WORD *)cmalloc(*num_dict*sizeof(DICT_WORD),"set_sim_dict_nhc")-1;
  ...
  /*  19)\cp_nhc_chunk{#} */
  i = 19;
  strcpy((*dict)[i].error_mes,"a number >= 1 ");
  strcpy((*dict)[i].keyword,"cp_nhc_chunk");
  strcpy((*dict)[i].keyarg,"1");
  /*------------------------------------------------------------------------*/
  /*========================================================================*/
  /*                   End Subprogram:                                      */
...
{ /*begin routine*/
  ...
  *num_dict = 4;
  *dict = (DICT_WORD *)cmalloc(*num_dict*sizeof(DICT_WORD),"set_sim_dict_vol")-1;
...
{ /*begin routine*/
  ...
  *num_dict = 12;
  *dict = (DICT_WORD *)cmalloc(*num_dict*sizeof(DICT_WORD),"set_sim_dict_pimd")-1;
  ...
  /*  12)\pimd_temperature{#} */
  strcpy((*dict)[12].error_mes,"A number >= 0");
  strcpy((*dict)[12].keyword,"pimd_temperature");
  strcpy((*dict)[12].keyarg,"0");
  /*========================================================================*/
  /*------------------------------------------------------------------------*/
  /*========================================================================*/
  /*                   End Subprogram:                                      */
...
{ /*begin routine*/
  ...
  *num_dict = 14;
  *dict = (DICT_WORD *)cmalloc(*num_dict*sizeof(DICT_WORD),"set_sim_dict_velo")-1;
...
{ /*begin routine*/
  ...
  *num_dict = 5;
  *dict = (DICT_WORD *)cmalloc(*num_dict*sizeof(DICT_WORD),"set_sim_dict_msqd")-1;
  /*========================================================================*/
  /*========================================================================*/
  /*  I- Initialize the user set option(did the user set the key word       */
...
{ /*begin routine*/
  ...
  *num_dict = 10;
  *dict = (DICT_WORD *)cmalloc(*num_dict*sizeof(DICT_WORD),"set_sim_dict_iikt_iso")-1;
  /*========================================================================*/
  /*========================================================================*/
  /*  I- Initialize the user set option(did the user set the key word       */
...
{ /*begin routine*/
  ...
  *num_dict = 7;
  *dict = (DICT_WORD *)cmalloc(*num_dict*sizeof(DICT_WORD),"set_sim_dict_ickt_iso")-1;
  /*========================================================================*/
  /*========================================================================*/
  /*  I- Initialize the user set option(did the user set the key word       */
...
{ /*begin routine*/
  ...
  *num_dict = 9;
  *dict = (DICT_WORD *)cmalloc(*num_dict*sizeof(DICT_WORD),"set_sim_dict_rdf")-1;
  /*========================================================================*/
  /*========================================================================*/
  /*  I- Initialize the user set option(did the user set the key word       */
