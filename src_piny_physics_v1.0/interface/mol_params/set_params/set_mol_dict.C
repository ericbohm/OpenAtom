...
/*==========================================================================*/
{
  ...
  *user_base_dict=(DICT_WORD*)cmalloc(*num_user_base_dict*sizeof(DICT_WORD),"set_user_base_dict")-1;
  ...
  /*-----------------------------------------------------------------------*/ 
  /* 8) /lj_explicit_file{} */
  strcpy((*user_base_dict)[8].keyword,"lj_explicit_file");
...
/*==========================================================================*/
  ...
  if(ifirst==1){
    *num_mol_dict = 13;
    *mol_dict      = (DICT_WORD *)cmalloc(*num_mol_dict*sizeof(DICT_WORD),"set_mol_dict")-1;
  }/*endif*/
  /*========================================================================*/
  /* I) Assign the users set flags 0 */
...
void set_bond_free_dict(DICT_WORD *bond_free_dict[],int *num_bond_free_dict)
{
  ...
  *bond_free_dict=(DICT_WORD*)cmalloc(*num_bond_free_dict*sizeof(DICT_WORD),"set_bond_free_dict")-1;
  /*========================================================================*/
  /* I) Assign the users set flags 0 */
...
/*==========================================================================*/
{
  ...
  *bend_free_dict = (DICT_WORD *)
    cmalloc(*num_bend_free_dict*sizeof(DICT_WORD),"set_bend_free_dict")-1;
  /*========================================================================*/
  /* I) Assign the users set flags 0 */
...
{/*begin routine*/
  ...
  *tors_free_dict=(DICT_WORD*)cmalloc(*num_tors_free_dict*sizeof(DICT_WORD),"set_tors_free_dict")-1;
  /*========================================================================*/
  /* I) Assign the users set flags 0 */
