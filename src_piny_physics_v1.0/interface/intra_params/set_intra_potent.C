...
#include "../class_defs/allclass_strip_mdintra.h"
  ...
  if((mdbend_bnd->ntyp) > 0){
    ...
    cfree(&(build_intra->ibend_bnd_typ_map[1]),"set_intra_potent");
  }/*endif*/
...
{ /*begin routine */ 
  ...
  int ntyp_23_tot,ntyp_33_tot,ntyp_watt_33_tot;
...
/* A) Power series                                                       */
  ...
  if(ntyp_pow > 0){
    ifound_pow = (int *)cmalloc(ntyp_pow*sizeof(int),"set_bond_potent")-1;
...
/* B.1) Normal cons                                                      */
  ...
  if(ntyp_con > 0){
    ifound_con = (int *)cmalloc(ntyp_con*sizeof(int),"set_bond_potent")-1;
...
/* B.2) Group cons 21 [1-2]                                              */
  ...
  if(ntyp_21 > 0){
    ifound_21 = (int *)cmalloc(ntyp_21*sizeof(int),"set_bond_potent")-1;
...
/* B.3) Group cons 23  [1-2,1-3]                                        */
  ...
  if(ntyp_23 > 0){
    ...
    ifound_23 = (int *)cmalloc(ntyp_23_tot*sizeof(int),"set_bond_potent")-1;
...
/* B.4) Group cons 33  [1-2,1-3,2-3]                                     */
  ...
  if(ntyp_33 > 0){
    ...
    ifound_33 = (int *)cmalloc(ntyp_33_tot*sizeof(int),"set_bond_potent")-1;
    isearch_33 = (int *)cmalloc(ntyp_33_tot*sizeof(int),"set_bond_potent")-1;
    igood_33 = (int *)cmalloc(ntyp_33_tot*sizeof(int),"set_bond_potent")-1;
    cbond_33 = 
      (CATM_LAB *)cmalloc(ntyp_33_tot*sizeof(CATM_LAB),"set_bond_potent")-1;
    for(i=1;i<=ntyp_33;i++){
      j1 = 3*i-2;
      j2 = 3*i-1;
      j3 = 3*i;
...
/* B.5) Group cons 43    [1-2,1-3,1-4]                                   */
  ...
  if(ntyp_43 > 0){
    ...
    ifound_43 = (int *)cmalloc(ntyp_43_tot*sizeof(int),"set_bond_potent")-1;
...
/* B.6) Group cons 46 [1-2,1-3,1-4,2-3,2-4,3-4]                          */
  ...
  if(ntyp_46 > 0){
    ...
    ifound_46 = (int *)cmalloc(ntyp_46_tot*sizeof(int),"set_bond_potent")-1;
    isearch_46 = (int *)cmalloc(ntyp_46_tot*sizeof(int),"set_bond_potent")-1;
    igood_46 = (int *)cmalloc(ntyp_46_tot*sizeof(int),"set_bond_potent")-1;
    cbond_46 = 
      (CATM_LAB *)cmalloc(ntyp_46_tot*sizeof(CATM_LAB),"set_bond_potent")-1;
    for(i=1;i<=ntyp_46;i++){
      j1 = 6*i-5;
      j2 = 6*i-4;
      j3 = 6*i-3;
...
/* IV) Free the memory. */
  if(ntyp_pow>0){
    ...
    cfree(&igood_pow[1],"set_bond_potent");
    cfree(&cbond_pow[1],"set_bond_potent");
  }/*endif*/
  if(ntyp_con>0){
    cfree(&ifound_con[1],"set_bond_potent");
    cfree(&isearch_con[1],"set_bond_potent");
    cfree(&igood_con[1],"set_bond_potent");
    cfree(&cbond_con[1],"set_bond_potent");
  }/*endif*/
  if(ntyp_21>0){
    cfree(&ifound_21[1],"set_bond_potent");
    cfree(&isearch_21[1],"set_bond_potent");
    cfree(&igood_21[1],"set_bond_potent");
    cfree(&cbond_21[1],"set_bond_potent");
  }/*endif*/
  if(ntyp_23>0){
    cfree(&ifound_23[1],"set_bond_potent");
    cfree(&isearch_23[1],"set_bond_potent");
    cfree(&igood_23[1],"set_bond_potent");
    cfree(&cbond_23[1],"set_bond_potent");
  }/*endif*/
  if(ntyp_33>0){
    cfree(&ifound_33[1],"set_bond_potent");
    cfree(&isearch_33[1],"set_bond_potent");
    cfree(&igood_33[1],"set_bond_potent");
    cfree(&cbond_33[1],"set_bond_potent");
  }/*endif*/
  if(ntyp_watt_33>0){
    cfree(&ifound_watt_33[1],"set_bond_potent");
    cfree(&isearch_watt_33[1],"set_bond_potent");
    cfree(&igood_watt_33[1],"set_bond_potent");
    cfree(&cbond_watt_33[1],"set_bond_potent");
  }/*endif*/
  if(ntyp_43>0){
    cfree(&ifound_43[1],"set_bond_potent");
    cfree(&isearch_43[1],"set_bond_potent");
...
/* 0) Search initialization. */
  ...
  if(ntyp_pow > 0){
    ifound_pow = (int *)cmalloc(ntyp_pow*sizeof(int),"set_tors_potent")-1;
...
/* IV) Free the memory. */
  if(ntyp_pow>0){
    ...
    cfree(&igood_pow[1],"set_tors_potent");
...
/* 0) Search initialization. */
  ...
  ntyp= onfo->ntyp;
  if(ntyp> 0){
    ifound= (int *)cmalloc(ntyp*sizeof(int),"set_onfo_potent")-1;
    isearch= (int *)cmalloc(ntyp*sizeof(int),"set_onfo_potent")-1;
    igood= (int *)cmalloc(ntyp*sizeof(int),"set_onfo_potent")-1;
    confo = (CATM_LAB *)cmalloc(ntyp*sizeof(CATM_LAB),"set_onfo_potent")-1;
    for(i=1;i<=ntyp;i++){
...
/* 0) Search initialization. */
  ...
  ntyp= bend_bnd->ntyp;
  if(ntyp> 0){
    ifound= (int *)cmalloc(ntyp*sizeof(int),"set_bend_bnd_potent")-1;
