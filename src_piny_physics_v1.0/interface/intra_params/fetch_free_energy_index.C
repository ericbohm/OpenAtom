...
#include "../class_defs/allclass_strip_mdintra.h"   
  ...
  int bond_free_num       = mdbond_free->num;
  int bend_free_num       = mdbend_free->num;
  int tors_free_num       = mdtors_free->num;
  int rbar_sig_free_iopt  = mdrbar_sig_free->iopt;
  ...
  int *bond_free_j1       = &(mdbond_free->j1);
  int *bond_free_j2       = &(mdbond_free->j2);
  ...
  int *bend_free_j1       = &(mdbend_free->j1);
  int *bend_free_j2       = &(mdbend_free->j2);
  int *bend_free_j3       = &(mdbend_free->j3);
  ...
  int *tors_free_j1       = mdtors_free->j1;
  int *tors_free_j2       = mdtors_free->j2;
  int *tors_free_j3       = mdtors_free->j3;
  int *tors_free_j4       = mdtors_free->j4;
