...
void set_grp_bond_params(DICT_WORD intra_dict[],int num_intra_dict,
    ...
    MDGHOST_ATOMS *ghost_atoms,MDGRP_BOND_CON *grp_bond_con,
    MDGRP_BOND_WATTS *grp_bond_watts,MDCONSTRNT *mdconstrnt,
...
{/*begin routine*/
  ...
  if(igo==1){
    ...
    if(igrp_type!=6){
      mdconstrnt->icons_jres_jmol_typ[ires_off+iresidue] = 1;
    }/*endif*/
    ...
    if(igrp_type==1){
      ...
      if(grp_bond_con->num_21+1 > build_intra->ngrp_21_max){
        ...
        grp_bond_con->j1_21     = (int *) crealloc(&(grp_bond_con->j1_21)[1],
            build_intra->ngrp_21_max*sizeof(int),"set_grp_bond_params")-1;
      ...
      if(itype>build_intra->ngrp_typ_21_max){
        ...
        build_intra->cgrp_typ_21      = (CGRP_CONS *) 
          crealloc(&(build_intra->cgrp_typ_21)[1],
              build_intra->ngrp_typ_21_max*sizeof(CGRP_CONS),"set_grp_bond_params")-1;
      }/*endif*/
      ...
      if((ghost_atoms->ighost_flag[grp_bond_con->j1_21[grp_bond_con->num_21]]!=0)||
          (ghost_atoms->ighost_flag[grp_bond_con->j2_21[grp_bond_con->num_21]]!=0)){
        PRINTF("@@@@@@@@@@@@@@@@@@@@_error_@@@@@@@@@@@@@@@@@@@@\n");
    ...
    if(igrp_type==2){
      ...
      if(grp_bond_con->num_23+1 > build_intra->ngrp_23_max){
        ...
        grp_bond_con->j1_23     = (int *) crealloc(&(grp_bond_con->j1_23)[1],
            build_intra->ngrp_23_max*sizeof(int),"set_grp_bond_params")-1;
      ...
      if(itype>build_intra->ngrp_typ_23_max){
        ...
        build_intra->cgrp_typ_23      = (CGRP_CONS *) 
          crealloc(&(build_intra->cgrp_typ_23)[1],
              build_intra->ngrp_typ_23_max*sizeof(CGRP_CONS),"set_grp_bond_params")-1;
      }/*endif*/
      ...
      if((ghost_atoms->ighost_flag[grp_bond_con->j1_23[grp_bond_con->num_23]]!=0)||
          (ghost_atoms->ighost_flag[grp_bond_con->j2_23[grp_bond_con->num_23]]!=0)||
          (ghost_atoms->ighost_flag[grp_bond_con->j3_23[grp_bond_con->num_23]]!=0)){
        PRINTF("@@@@@@@@@@@@@@@@@@@@_error_@@@@@@@@@@@@@@@@@@@@\n");
        PRINTF("Ghost atoms are not permitted in group constraints\n");
        PRINTF("in molecule index %d in residue index %d in file %s\n",
            jmol_typ,iresidue,file_name);
    ...
    if(igrp_type==3){
      ...
      if(grp_bond_con->num_33+1 > build_intra->ngrp_33_max){
        ...
        grp_bond_con->j1_33     = (int *) crealloc(&(grp_bond_con->j1_33)[1],
            build_intra->ngrp_33_max*sizeof(int),"set_grp_bond_params")-1;
      ...
      if(itype>build_intra->ngrp_typ_33_max){
        ...
        build_intra->cgrp_typ_33      = (CGRP_CONS *) 
          crealloc(&(build_intra->cgrp_typ_33)[1],
              build_intra->ngrp_typ_33_max*sizeof(CGRP_CONS),"set_grp_bond_params")-1;
      }/*endif*/
      ...
      if((ghost_atoms->ighost_flag[grp_bond_con->j1_33[grp_bond_con->num_33]]!=0)||
          (ghost_atoms->ighost_flag[grp_bond_con->j2_33[grp_bond_con->num_33]]!=0)||
          (ghost_atoms->ighost_flag[grp_bond_con->j3_33[grp_bond_con->num_33]]!=0)){
        PRINTF("@@@@@@@@@@@@@@@@@@@@_error_@@@@@@@@@@@@@@@@@@@@\n");
        PRINTF("Ghost atoms are not permitted in group constraints\n");
        PRINTF("in molecule index %d in residue index %d in file %s\n",
            jmol_typ,iresidue,file_name);
      ...
      if(grp_bond_watts->num_33+1 > build_intra->ngrp_watt_33_max){
        ...
        grp_bond_watts->j1_33     = 
          (int *) crealloc(&(grp_bond_watts->j1_33)[1],
              build_intra->ngrp_watt_33_max*sizeof(int),"set_grp_bond_params")-1;
      ...
      if(itype>build_intra->ngrp_typ_watt_33_max){
        ...
        build_intra->cgrp_typ_watt_33      = (CGRP_CONS *) 
          crealloc(&(build_intra->cgrp_typ_watt_33)[1],
              build_intra->ngrp_typ_watt_33_max*sizeof(CGRP_CONS),
              "set_grp_bond_params")-1;
      }/*endif*/
    ...
    if(igrp_type==5){
      ...
      if(grp_bond_con->num_43+1 > build_intra->ngrp_43_max){
        ...
        grp_bond_con->j1_43     = (int *) crealloc(&(grp_bond_con->j1_43)[1],
            build_intra->ngrp_43_max*sizeof(int),"set_grp_bond_params")-1;
      ...
      if(itype>build_intra->ngrp_typ_43_max){
        ...
        build_intra->cgrp_typ_43      = (CGRP_CONS *) 
          crealloc(&(build_intra->cgrp_typ_43)[1],
              build_intra->ngrp_typ_43_max*sizeof(CGRP_CONS),"set_grp_bond_params")-1;
      }/*endif*/
      ...
      if((ghost_atoms->ighost_flag[grp_bond_con->j1_43[grp_bond_con->num_43]]!=0)||
          (ghost_atoms->ighost_flag[grp_bond_con->j2_43[grp_bond_con->num_43]]!=0)||
          (ghost_atoms->ighost_flag[grp_bond_con->j3_43[grp_bond_con->num_43]]!=0)||
          (ghost_atoms->ighost_flag[grp_bond_con->j4_43[grp_bond_con->num_43]]!=0)){
        PRINTF("@@@@@@@@@@@@@@@@@@@@_error_@@@@@@@@@@@@@@@@@@@@\n");
        PRINTF("Ghost atoms are not permitted in group constraints\n");
        PRINTF("in molecule index %d in residue index %d in file %s\n",
            jmol_typ,iresidue,file_name);
    ...
    if(igrp_type==4){
      ...
      if(grp_bond_con->num_46+1 > build_intra->ngrp_46_max){
        ...
        grp_bond_con->j1_46     = (int *) crealloc(&(grp_bond_con->j1_46)[1],
            build_intra->ngrp_46_max*sizeof(int),"set_grp_bond_params")-1;
      ...
      if(itype>build_intra->ngrp_typ_46_max){
        ...
        build_intra->cgrp_typ_46      = (CGRP_CONS *) 
          crealloc(&(build_intra->cgrp_typ_46)[1],
              build_intra->ngrp_typ_46_max*sizeof(CGRP_CONS),"set_grp_bond_params")-1;
      }/*endif*/
      ...
      if((ghost_atoms->ighost_flag[grp_bond_con->j1_46[grp_bond_con->num_46]]!=0)||
          (ghost_atoms->ighost_flag[grp_bond_con->j2_46[grp_bond_con->num_46]]!=0)||
          (ghost_atoms->ighost_flag[grp_bond_con->j3_46[grp_bond_con->num_46]]!=0)||
          (ghost_atoms->ighost_flag[grp_bond_con->j4_46[grp_bond_con->num_46]]!=0)){
        PRINTF("@@@@@@@@@@@@@@@@@@@@_error_@@@@@@@@@@@@@@@@@@@@\n");
        PRINTF("Ghost atoms are not permitted in group constraints\n");
        PRINTF("in molecule index %d in residue index %d in file %s\n",
            jmol_typ,iresidue,file_name);
