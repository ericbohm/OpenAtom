...
{ /*begin routine*/
  ...
  r = (double *)cmalloc(nsplin*sizeof(double),"spline_fit")-1;
  sw = (double *)cmalloc(nsplin*sizeof(double),"spline_fit")-1;
  dsw = (double *)cmalloc(nsplin*sizeof(double),"spline_fit")-1;
  ...
  *dri = 1.0/(*dr);
  ...
  cfree(&r[1],"spline_vdv");
  cfree(&sw[1],"spline_vdv");
  cfree(&dsw[1],"spline_vdv");
