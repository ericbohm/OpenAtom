...
/*cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc*/
/*==========================================================================*/
/*  set_pot_force_field_dict:set up the atom  key word dictionary           */ 
/*==========================================================================*/
...
{/*begin routine*/
  ...
  strcpy((*explicit_lj_dict)[1].keyarg,"");
  strcpy((*explicit_lj_dict)[1].error_mes,"");
  (*explicit_lj_dict)[1].key_type = 1;  /* must spec*/

  /*-----------------------------------------------------------------------*/ 
  /*  2) \epsilon{} */
  strcpy((*explicit_lj_dict)[2].keyword,"eps");
  strcpy((*explicit_lj_dict)[2].keyarg,"119.8");
  strcpy((*explicit_lj_dict)[2].error_mes,"A number >= 0");

  /*-----------------------------------------------------------------------*/ 
  /*  3) \sigma{} */
  strcpy((*explicit_lj_dict)[3].keyword,"sig");
  strcpy((*explicit_lj_dict)[3].keyarg,"3.4");
  strcpy((*explicit_lj_dict)[3].error_mes,"A number >= 0");

  /*-----------------------------------------------------------------------*/ 
  /*  4) \rcut{} */
  strcpy((*explicit_lj_dict)[4].keyword,"rcut");
  strcpy((*explicit_lj_dict)[4].keyarg,"5.6");
  strcpy((*explicit_lj_dict)[4].error_mes,"A number >= 0");

  /*-----------------------------------------------------------------------*/ 
  /*  5) \rcut_res{} */
  strcpy((*explicit_lj_dict)[5].keyword,"rcut_res");
  strcpy((*explicit_lj_dict)[5].keyarg,"5.6");
  strcpy((*explicit_lj_dict)[5].error_mes,"A number >= 0");
